...
##Section 2, Question 2 (3rd-5th visualizations, Doyle)

```{r visualation 0.1, warning=FALSE,message=FALSE}
library(plyr)
library(dplyr)
library(tidyverse)
library(ggplot2)
...
```{r visualation 0.2, warning=FALSE,message=FALSE}
library(plyr)
library(dplyr)
library(tidyverse)
library(ggplot2)
...
```{r visualation 0.3, warning=FALSE,message=FALSE}
library(plyr)
library(dplyr)
library(tidyverse)
library(ggplot2)
