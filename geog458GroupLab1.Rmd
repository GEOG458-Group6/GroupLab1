...
###Output Data Narration
        ...
        These two reasons are represented on the graph of *Output of 4 Municipalities* by a minimal-fluctuate line.

###Enterprise Data Narration
        After the Chinese Revolution of 1949, China’s enterprise ownership was transformed into the public-owned collective economy. The Chinese government formed “Collective farm” and the “People’s commune” in rural areas. The People’s Commune was a collective owned economic organization representing the grass-roots organ of state power in rural areas that involved in agricultural, industrial and commercial activities[^1]. Thus, those pre-existing cooperatives, especially in cities, were merged into the people’s communes[^2] in the countryside, causing the number of enterprises dropped in Mao's era(1949-1976). Chongqing might instead have more enterprise, People's Commune in its case, having a more collective form of the economy during the Mao's era, since Chongqing was recreated as a municipality in 1997.
        China experienced Chinese Economic Reform two years after Mao's death. Private sector economy was largely encouraged. Some townships are sold to individuals and more new cooperates are established, correspondly showing a increse on the graph of *Enterprise Data of 4 Municipalities*.
  
[^1]: Shuang, S. (2010, December). People's Communes. Retrieved from http://www.chinatoday.com.cn/ctenglish/se/txt/2009-03/11/content_184433.htm
[^2]: Great Leap Forward (1958-1961). (n.d.). Retrieved from https://chineseposters.net/themes/great-leap-forward.php
