...
###3.4 Graph Explanation
        ...
        These four graphs show the difference between the National Bureau of Statistics(NBS) of China and the All China Center Data(CDC) from 1998 to 2016. The bars' heights represent how significant the differences are. If the bar is above the x-axis, that means, for that specific year, the NBS data is higher than the CDC data. If the bar is below the x-axis, the NBS data is lower than the CDC data in that specific year. CDC dataset has few data missing in 2017, and these are not showing on the graph because the difference can't be estimated.
