...
ggplot(data=Chinaa,aes(x=Year,y=value,colour=variable))+geom_point(color="red",pch=20,size=3)+ggtitle("Output of Beijing, Inner Mongolia, and Tibet, 2000-2017")+theme_bw()+ scale_size_area()+ stat_smooth(method = lm, formula = y ~ splines::bs(x, 5), se = FALSE)
```
